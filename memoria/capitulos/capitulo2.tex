...
\subsubsection{Proyecto piloto de un robot manipulador para cosechar tomates}
...
\begin{figure}[h!]
    \begin{center}
      \subcapcentertrue
      \subfigure[Conexión eléctrica entre los componentes del robot recolector]{\includegraphics[width=12cm]{figs/Componentes recolector tomates.png}}
      \hspace{2mm}
      \subfigure[Diseño tridimensional del robot recolector]{\includegraphics[width=12cm]{figs/Diseño 3D recolector tomates.png}}
    \end{center}
