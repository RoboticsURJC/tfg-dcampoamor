...
\begin{figure}[H]
    \begin{center}
      \subcapcentertrue
      \subfigure[Robot Dogtooth]{\includegraphics[width=12cm]{figs/Dogtooth.jpg}}
      \hspace{2mm}
      \subfigure[Brazo robótico del Dogtooth]{\includegraphics[width=10cm]{Brazo Dogtooth.png}}
    \end{center}
