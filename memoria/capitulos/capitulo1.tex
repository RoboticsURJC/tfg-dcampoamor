...
\begin{itemize}
 \item \textit{Robots de asistencia personal:} robot diseñado específicamente para ayudar a las personas en sus actividades diarias y mejorar su calidad de vida. Estos robots están diseñados para interactuar de manera segura y útil con humanos y generalmente se utilizan en situaciones en las que se requiere apoyo adicional, ya sea debido a la edad, la discapacidad o cualquier otra necesidad especial. 
