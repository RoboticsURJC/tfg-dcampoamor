...
Actualmente la Inteligencia Artificial es un area de la ciencia de gran interés por ser un área multidiciplinaria donde se realizan sistemas que tratan de hacer tareas y resolver problemas como lo hace un humano, así mismo se trata de simular de manera artificial las formas del pensamiento y como trabaja el cerebro para tomar desiciones \cite{Ponce14}.\\
