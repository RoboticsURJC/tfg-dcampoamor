...
Las primeras aplicaciones fueron en neurocirugía y cirugía ortopédica, y aunque los primeros avances en este campo fueron algo inestables, como cabe esperar de la introducción de cualquier tecnología radicalmente nueva, la robótica médica ha alcanzado un nivel de madurez que ha animado al sector sanitario a realizar importantes inversiones en el campo de la cirugía a distancia. A medida que se ha hecho patente la aceptación de los robots quirúrgicos por nuestros sistemas sanitarios, los investigadores en robótica han ido centrando cada vez más su atención en cómo podría ser la próxima generación de robots médicos. Su atención no se limita a los robots quirúrgicos, y también se están investigando otras áreas de la medicina, como los robots para realizar rehabilitación física, robots de telepresencia para la interacción del paciente con el personal sanitario externo, automatización de farmacias, robots para desinfectar clínicas, etc. \cite{Dupont21}

\begin{figure} [h!]
    \begin{center}
      \includegraphics[width=6cm]{figs/Robot Da Vinci.png}
    \end{center}
    \caption{Carro del robot Da Vinci.}
    \label{fig:DaVinci}
  \end{figure}
