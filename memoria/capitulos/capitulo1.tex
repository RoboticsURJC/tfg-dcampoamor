...
El término \textit{aprendizaje profundo} fue introducido por primera vez en el aprendizaje automático por Rina Dechter en \cite{Dechter86}, y en las redes neuronales artificiales (NN) mediante \cite{Aizenberg00}. Posteriormente, se hizo especialmente popular en el contexto de las NN profundas, sin embargo, los Deep Learners más exitosos son mucho más antiguos, remontándose a más de medio siglo atrás \cite{Schmidhuber15}.
