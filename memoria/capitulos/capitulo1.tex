...
\begin{itemize}
 ...
 \begin{figure}[h!]
    \begin{center}
      \subcapcentertrue
      \subfigure[Spot de Boston Dynamics]{\includegraphics[width=70mm]{figs/Spot.png}}
      \hspace{2mm}
      \subfigure[ROBTET, robot para el mantenimiento de líneas de alta tensión]{\includegraphics[width=65mm]{figs/ROBTET.png}}
    \end{center}
...
Hace poco más de tres décadas, los primeros roboticistas empezaron a explorar el uso de manipuladores robóticos para realizar intervenciones quirúrgicas. Hace dos décadas se instalaron los primeros sistemas comerciales en hospitales. En la última década, el campo de la robótica médica ha cobrado impulso, y en la actualidad hay miles de sistemas quirúrgicos robóticos instalados en clínicas de todo el mundo, y se han realizado muchos millones de procedimientos. A medida que se ha hecho patente la aceptación de los robots quirúrgicos por nuestros sistemas sanitarios, los investigadores en robótica han ido centrando cada vez más su atención en cómo podría ser la próxima generación de robots médicos. Su atención no se limita a los robots quirúrgicos, y también se están investigando otras áreas de la medicina, como los robots para realizar rehabilitación física, los robots de telepresencia para la interacción del paciente con el personal sanitario externo, la automatización de farmacias, los robots para desinfectar clínicas, etc.
