...
\begin{itemize}
 ...
 \item \textit{Entretenimiento:} Son robots diseñados específicamente para proporcionar experiencias lúdicas y de entretenimiento a las personas. Estos robots se utilizan en una variedad de contextos, siendo máquinas robóticas diseñadas para interactuar con el público. 
  ...
  \begin{figure}[h!]
    \begin{center}
      \subcapcentertrue
      \subfigure[SONY Aibo]{\includegraphics[width=60mm]{figs/SONY Aibo.png}}
      \hspace{2mm}
      \subfigure[Dron DJI Spark]{\includegraphics[width=88mm]{figs/Dron DJI Spark.png}}
      \hspace{2mm}
      \subfigure[Robot Honda ASIMO]{\includegraphics[width=50mm]{figs/ASIMO.jpg}}
    \end{center}
...
\begin{figure} [h!]
    \begin{center}
      \includegraphics[width=12cm]{figs/Usos y aplicaciones de los robots de servicios.png}
    \end{center}
    \caption{Aplicaciones de los robots de servicios en diferentes áreas de operación.}
    \label{fig:Aplicaciones de los robots servicio}
\end{figure}
