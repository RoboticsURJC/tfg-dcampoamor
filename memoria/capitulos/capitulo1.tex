...
La visión artificial se define como la ciencia de programar un ordenador para procesar imágenes o videos e incluso entenderlos \cite{Culjak12}. En \cite{Bradski08} explica que es la transformación de datos desde un fotograma o video cámara en lo que puede ser una decisión o una nueva representación. 
