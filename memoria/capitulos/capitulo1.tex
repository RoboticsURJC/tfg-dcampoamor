...
En definitiva, la robótica se puede enmarcar como una rama de la ciencia y la ingeniería que se encarga del estudio, diseño, construcción y programación de robots. Atendiendo al propósito y al contexto en el que se utilicen estos robots, se pueden clasificar en tres grandes grupos en función de una serie de criterios generales: \textit{robots industriales},\textit{robots de servicio} y \textit{robots médicos}.\\
