...
#Este programa está probado para funcionar y detectar objetos por defecto con la webcam del PC
        ...
        for detection in detections:
    	    if detection is not None:
                ...
                for x1, y1, x2, y2, conf, cls_conf, cls_pred in detection:
                    ...
                    print("El punto central del recuadro es X: {}, Y: {}".format(x_central,y_central))
                    ...
                    org = (int(x2), int(y2 - int(box_h)))  # Asegura que ambas coordenadas sean enteros
